...
class SlideshowImages(models.Model):
	...
	def __str__(self):
		return f"{self.title}"
	class Meta:
        	verbose_name_plural = "Slideshow Images for Homepage"
...
class Statisticscannon(models.Model):
	...
	class Meta:
        	verbose_name_plural = "Statistics for Cannon"
...
class EventTopImage(models.Model):
	...
	class Meta:
        	verbose_name_plural = "Top image on Events page"
...
class RutherfordService(models.Model):
	...
	def __str__(self):
		return f"{self.title}"
	class Meta:
        	verbose_name_plural = "Rutherford Service"
...
class CannonService(models.Model):
	...
	def __str__(self):
		return f"{self.title}"
	class Meta:
        	verbose_name_plural = "Cannon Service"
...
class MediaInformation(models.Model):
	...
	def __str__(self):
		return f"{self.title}"
	class Meta:
        	verbose_name_plural = "Media Information"
...
class Imagesond2l(models.Model):
	...
	class Meta:
        	verbose_name_plural = "Images on D2l"
...
class DarknesstoLight(models.Model):
	...
	class Meta:
        	verbose_name_plural = "Darkness to Light"
